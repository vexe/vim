hi clear
syntax reset
let g:colors_name = "classic_blue2"
if &background == "light"
...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#00c200 guibg=NONE
    ...
    hi Conditional gui=NONE guifg=#00c200 guibg=NONE
    ...
    hi Normal gui=NONE guifg=#b0b0b0 guibg=#0e0e5d
    hi Number gui=NONE guifg=#bfbfbf guibg=NONE
    ...
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#00c200 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
